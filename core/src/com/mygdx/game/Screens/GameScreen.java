...
public class GameScreen implements Screen {
    ...
    public void render(float delta) {
        ...
        System.out.println(taskTypeSelected);
    ...
    public void initialiseTextures(){
        ...
        File directory= new File("assets/Textures/TileTextures");
        String[] files = directory.list();
        assert files != null;
        for (String fileName : files) {
            String[] temp = fileName.split("\\.");
            tileTextures.put(temp[0], new Texture(Gdx.files.internal("assets/Textures/TileTextures/" + fileName)));
        }

        File directory2= new File("assets/Textures/ThingTextures");
        ...
        for (String fileName : files2) {
            ...
            if (temp[1].equals("atlas")){
                thingTextures.put(temp[0], new TextureAtlas(Gdx.files.internal("assets/Textures/ThingTextures/" + fileName)));
            }
        }
    }
    ...
    public void saveGame(String saveName){
        ...
        File file = new File("assets/Saves/" + saveName);
        System.out.println(file.mkdir());

        File file2Save = new File("assets/Saves/" + saveName + "/save.txt");
        try {
        ...
        FileHandle fileHandle = Gdx.files.local("assets/Saves/" + saveName + "/save.sve");
    ...
    public void setCustomCursor(String name){
        Pixmap px = new Pixmap(new FileHandle("assets/Textures/ui/cursor/" + name + ".png"));
